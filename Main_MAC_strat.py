...
from Strategies.MAC_Strat import MovingAverageCrossOverStrategy
...
if __name__ == "__main__":
    ...
    backtest = Backtest(data_dir,  # data directory of CSV files
                        ...
                        heartbeat,
                        # heartbeat to count time in real live trading
                        # simulation
                        ...
                        # Type of execution in relationship to broker
                        Portfolio,  # portfolio management method
                        TradingStrategy)  # strategy chosen
